...
onMounted(async () => {
    try {
        const res = await fetch("https://my.api.mockaroo.com/dtpv.json?key=a0e7b470", {
            headers: {
    ...
    <AppLayout title="Tabla xml">
        <div class="card">
            <DataTable :value="products" tableStyle="min-width: 50rem">
                ...
                <Column field="fecha_certificacion" header="Fecha de certificación" />
                <Column field="pac_certifico" header="PAC que Certificó" />
                <Column field="importe" header="Importe" />
                <Column field="fecha_cancelacion" header="Fecha de cancelación" />
                ...
                <Column field="proveedor_generico" header="Proveedor genérico" />
